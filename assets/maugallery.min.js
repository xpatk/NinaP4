!(function (a) {
  (a.fn.mauGallery = function (t) {
    ...
    (a.fn.mauGallery.methods = {
      ...
      prevImage(e) {
        let currentImage = a(`#${e}`).find(".lightboxImage").attr("src");
        let galleryItems = a(".gallery-item");
        ...
        a(`#${e}`)
          .find(".lightboxImage")
          .attr("src", galleryItems.eq(prevIndex).attr("src"));
      },
      nextImage(e) {
        let currentImage = a(`#${e}`).find(".lightboxImage").attr("src");
        let galleryItems = a(".gallery-item");
        ...
        a(`#${e}`)
          .find(".lightboxImage")
          .attr("src", galleryItems.eq(nextIndex).attr("src"));
      },
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-body">
                    ${
                      e
                        ? '<div class="mg-prev" style="cursor:pointer;position:absolute;top:50%;left:10px;background:white;">&lt;</div>'
                        : '<span style="display:none;" />'
                    }
                    <img class="lightboxImage img-fluid" alt="Image content"/>
                    ${
                      e
                        ? '<div class="mg-next" style="cursor:pointer;position:absolute;top:50%;right:10px;background:white;">&gt;</div>'
                        : '<span style="display:none;" />'
                    }
                  </div>
                </div>
